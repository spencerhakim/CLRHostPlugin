...
namespace CLROBS {
    ...
    void XElement::ReverseOrder() { element->ReverseOrder(); }
    void XElement::MoveUp() { element->MoveUp(); }
    void XElement::MoveDown() { element->MoveDown(); }
    void XElement::MoveToTop() { element->MoveToTop(); }
    void XElement::MoveToBottom() { element->MoveToBottom(); }
    ...
    Generic::List<System::String^>^ XElement::GetStringList(System::String^ name)
    {
        StringList list;
    ...
    void XElement::SetString(System::String^ name, System::String^ string)
    {
        element->SetString(ToWString(name).c_str(), ToWString(string).c_str());
    }

    void XElement::SetInt(System::String^ name, System::Int32 number)
    {
        element->SetInt(ToWString(name).c_str(), number);
    }

    void XElement::SetFloat(System::String^ name, float number)
    {
        element->SetFloat(ToWString(name).c_str(), number);
    }

    void XElement::SetHex(System::String^ name, System::Int32 hex)
    {
        element->SetHex(ToWString(name).c_str(), hex);
    }

    void XElement::SetColor(System::String^ name, System::Int32 color)
    {
        SetHex(name, color);
    }

    void XElement::SetStringList(System::String^ name, Generic::List<System::String^>^ list)
    {
        StringList _list;
    ...
    void XElement::SetIntList(System::String^ name, Generic::List<System::Int32>^ list)
    {
        List<int> _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(list[i]);
    ...
    void XElement::SetFloatList(System::String^ name, Generic::List<float>^ list)
    {
        List<float> _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(list[i]);
    ...
    void XElement::SetHexList(System::String^ name, Generic::List<System::Int32>^ list)
    {
        List<DWORD> _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(list[i]);
    ...
    void XElement::SetColorList(System::String^ name, Generic::List<System::Int32>^ list)
    {
        SetHexList(name, list);
    }

    void XElement::AddString(System::String^ name, System::String^ string)
    {
        element->AddString(ToWString(name).c_str(), (TSTR)ToWString(string).c_str());
    }

    void XElement::AddInt(System::String^ name, System::Int32 number)
    {
        element->AddInt(ToWString(name).c_str(), number);
    }

    void XElement::AddFloat(System::String^ name, float number)
    {
        element->AddFloat(ToWString(name).c_str(), number);
    }

    void XElement::AddHex(System::String^ name, System::Int32 hex)
    {
        element->AddHex(ToWString(name).c_str(), hex);
    }

    void XElement::AddColor(System::String^ name, System::Int32 color)
    {
        AddHex(name, color);
    }

    void XElement::AddStringList(System::String^ name, Generic::List<System::String^>^ list)
    {
        StringList _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(ToWString(list[i]).c_str());
    ...
    void XElement::AddIntList(System::String^ name, Generic::List<System::Int32>^ list)
    {
        List<int> _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(list[i]);
    ...
    void XElement::AddFloatList(System::String^ name, Generic::List<float>^ list)
    {
        List<float> _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(list[i]);
    ...
    void XElement::AddHexList(System::String^ name, Generic::List<System::Int32>^ list)
    {
        List<DWORD> _list;
        for (int i = 0; i < list->Count; i++) {
            _list.Add(list[i]);
    ...
    void XElement::AddColorList(System::String^ name, Generic::List<System::Int32>^ list)
    {
